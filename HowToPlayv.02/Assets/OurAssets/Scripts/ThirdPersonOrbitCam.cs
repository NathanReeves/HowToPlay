...
public class ThirdPersonOrbitCam : MonoBehaviour 
{
	...
	void LateUpdate()
	{
		...
		angleH += Mathf.Clamp(Input.GetAxis("Fire2"), -1, 1) * horizontalAimingSpeed * Time.deltaTime;
		angleV += Mathf.Clamp(Input.GetAxis("Fire1")*-1, -1, 1) * verticalAimingSpeed * Time.deltaTime;
